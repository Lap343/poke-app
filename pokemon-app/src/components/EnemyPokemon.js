      ...
      {!enemyPokemon ? null : (
        <><div className="enemy-pokemon">
          ...
          <div 
            ...
            className={`enemy-pokemon__stats-title ${enemyStatsOnTop ? "on-tip-top" : ""}`}
          >Stats:</div>

          <div 
            onClick={() => setEnemyStatsOnTop(false)}
            className={`enemy-pokemon__moves-title ${enemyStatsOnTop ? "" : "on-tip-top"}`}
          >Moves:</div>

          <div className={`enemy-pokemon__stats ${enemyStatsOnTop ? "on-top" : ""}`}>
            <ol className="enemy-pokemon__stats-list">
              {!enemyPokemon?.stats
                ? null
                : enemyPokemon?.stats.map((statData, statIndex) => (
                  <div key={statIndex}>
                    <liv>{statData.stat.name}:</li>
          ...
          <div className={`enemy-pokemon__moves ${enemyStatsOnTop ? "" : "on-top"}`}>
